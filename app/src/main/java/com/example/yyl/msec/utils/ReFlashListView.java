...
public class ReFlashListView extends ListView implements OnScrollListener {
	...
	private void initView(Context context) {
		...
		header = inflater.inflate(R.layout.refresh_listview_header, null);
		footer=inflater.inflate(R.layout.refresh_listview_footer,null);
	...
	private void reflashViewByState() {
		ProgressBar  progressBarfooter= (ProgressBar) footer.findViewById(R.id.pb_pull_list_footer);
		TextView textload= (TextView) footer.findViewById(R.id.tv_pull_list_footer_title);
