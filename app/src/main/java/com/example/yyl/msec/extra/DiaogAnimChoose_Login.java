package com.example.yyl.msec.extra;

import android.content.Context;
import android.view.View;
import android.widget.AdapterView;

import com.example.yyl.msec.activity.LoginActivity;
...
public class DiaogAnimChoose_Login {
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    ((LoginActivity) context).setBasIn((BaseAnimatorSet) cs[position].newInstance());
    ...
    public static void dissmissAnim(final Context context) {
        ...
        dialog.setOnOperItemClickL(new OnOperItemClickL() {
            ...
            public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    String animType = contents[position];
                    ((LoginActivity) context).setBasOut((BaseAnimatorSet) cs[position].newInstance());
                    T.showShort(context, animType + "设置成功");
                    dialog.dismiss();
                } catch (Exception e) {
                    e.printStackTrace();
